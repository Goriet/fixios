...
import 'package:fluttermultistoreflutter/provider/comment/comment_header_provider.dart';
...
import 'package:fluttermultistoreflutter/viewobject/holder/comment_header_holder.dart';
          ...
          return CommetListItem(
            ...
            onTap: () async {
              ...
              if (data != null) {
                ...
                // if (widget.provider.commentHeaderList != null && widget.provider.commentHeaderList.data != null)
                //   widget.provider.commentHeaderList.data[index]
                //       .commentReplyCount = widget.provider.commentHeaderList.data[].commentReplyCount;
              }
            },
          );
        },
