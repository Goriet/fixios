...
import 'package:fluttermultistoreflutter/ui/shop_dashboard/item/blog_slider_tag.dart';
        ...
        child: Container(
          ...
          child: CustomScrollView(
            ...
            slivers: <Widget>[
              ...
              //------widget tiendas comerciales-------//
              //_HomeTagSliderListWidget(
              //animationController:
              //widget.animationController, //animationController,
              //animation: Tween<double>(begin: 0.0, end: 1.0).animate(
              // CurvedAnimation(
...
class _HomeTagSliderListWidget extends StatelessWidget {
  const _HomeTagSliderListWidget({
    Key key,
    @required this.animationController,
    @required this.animation,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SliverToBoxAdapter(
      child: Consumer<ShopTagProvider>(builder: (BuildContext context,
          ShopTagProvider shopTagProvider, Widget child) {
        if (shopTagProvider.shopTagList != null &&
            shopTagProvider.shopTagList.data != null &&
            shopTagProvider.shopTagList.data.isNotEmpty) {
          return AnimatedBuilder(
              animation: animationController,
              builder: (BuildContext context, Widget child) {
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              margin: const EdgeInsets.only(
                                  ...
                                  bottom: PsDimens.space20),
                              width: double.infinity,
                              child: (shopTagProvider.shopTagList.data != null)
                                  ? BlogSliderTagView(
                                      subShopTagList:
                                          shopTagProvider.shopTagList.data,
                                      onTap: (ShopTag shopTag) {
                                        Navigator.pushNamed(
                                            context, RoutePaths.shopTagList,
                                            arguments: shopTagProvider);
                                      },
