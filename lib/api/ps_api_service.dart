...
class PsApiService extends PsApi {
  ...
  Future<PsResource<List<Blog>>> getBlogListByTagId(
      String tagId, int limit, int offset) async {
    final String url =
        '${PsUrl.ps_get_shop_by_tagid_url}/api_key/${PsConfig.ps_api_key}/get_shop_by_tagid/$tagId/limit/$limit/offset/$offset';
