// Copyright (c) 2021, the SOS Servicios.  Please see the AUTHORS file
// for details. All rights reserved. Use of this source code is governed by a
// SOS Servicios license that can be found in the LICENSE file.
...
class PsConfig {
  ...
  static const String ps_app_url =
      'http://acomprarapp.iggestionempresarial.com/index.php/';

  static const String ps_app_image_url =
      'http://acomprarapp.iggestionempresarial.com/uploads/';

  static const String ps_app_image_thumbs_url =
      'http://acomprarapp.iggestionempresarial.com/uploads/thumbnail/';
  ...
  static bool showAdMob = true;
  static String androidAdMobAdsIdKey = 'ca-app-pub-4143617091803990~7406277149';
  static String androidAdMobUnitIdApiKey =
      'ca-app-pub-4143617091803990/2070189983';
  static String iosAdMobAdsIdKey = 'ca-app-pub-4143617091803990~7406277149';
  static String iosAdMobUnitIdApiKey = 'ca-app-pub-4143617091803990/2070189983';
...
// static const ps_language_list = [Locale('en', 'US'), Locale('ar', 'DZ')];
  ...
  /// Default Limit
  ///
  static const int DEFAULT_LOADING_LIMIT = 60;
