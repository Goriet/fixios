...
class PsColors {
  ...
  static const Color _c_main_color = Color(0xFF98C043);
  static const Color _c_main_light_color = Color(0xFFFFFFFF); //FFF0F1);
  static const Color _c_main_dark_color = Color(0xFFCC7012);
  static const Color _c_main_green_color = Color(0xFF4BA919);
  ...
  static void _loadDarkColors() {
    ...
    mainGreenColor = _c_main_green_color;
